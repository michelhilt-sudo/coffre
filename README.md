...
Safe — gestionnaire de mots de passe personnel, application web installable sur iPhone (PWA), **chiffrée** et **100 % locale**.
...
3. Lancer *Safe* depuis l'écran d'accueil et choisir son code.
